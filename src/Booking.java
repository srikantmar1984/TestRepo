...
public class Booking
{
    ...
    static String[] pnr_main = new String[0]; // 5 trains for 10 dates =50 and for initiation of seats 0
    ...
    static String[][] trainStopages = {{"TATA JN 06:15 AM","Ghatshila 7:00 AM","Chakuliya 7:30 AM","Jhargram 7:40 AM","Shordia 8:05 AM","Kharagpur 8:30 AM","Howrah 10:20 AM"}
                        ,{ "HOWRAH JN 09:15 AM","Kharagpur 11:05 AM","Tata Nagar 1:00 PM","Rourkella 4:00 PM","Raigad 6:30 PM","Bilaspur 8:15 PM","Raipur 9:30 PM","Nagpur 11:30 PM","Nashik 3:30 AM","Mumbai 7:30 AM"}
                        ,{"HOWRAH JN 10:20 PM","Kharagpur 00:00 AM","Tata Nagar 2:00 AM","Rourkella 5:00 AM","Raigad 7:00 AM","Bilaspur 8:45 AM","Raipur 10:00 AM","Itarashi 01:00 PM","Ahemadnagar 4:30 PM","Pune 5:30 PM"}
                        ,{"AMRITSAR JN 11:05 AM","New Delhi 2:30 PM","Lucknow 7:30 PM","Varanasi 00:30 AM","Gaya 5:30 AM","Bokaro 7:15 AM","Puruliya 10:00 AM","Tata 11:30 AM"}
                        ,{"MUMBAI JN 08:30 AM","Nashik  11:30 AM","Nagpur 5:30 PM","ujjain 08:30 PM","Bhopal 10:30 PM","JabalPur 04:30 AM","Agra 06:30 AM", "New Delhi 09:00 AM"}};
    ...
    static String bookticket( int trainSlNo,int bStationSlno,int dStationSlno, int fare,int jDateSlno,String[][] passengerDtls){
    	...
    	try {
	        ...
	        ticket_print+="\n"+String.format("%-20s","Bording Station")+" : "+trainStopages[trainSlNo][bStationSlno];
	        ticket_print+="\n"+String.format("%-20s","Destination Station")+" : "+trainStopages[trainSlNo][dStationSlno];
    ...
    static void ticketBooking(){
    	...
    	try {
	        ...
	        System.out.print("\n Enter journey date from the list");
